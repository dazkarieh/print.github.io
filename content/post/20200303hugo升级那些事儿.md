...
除却一些鸡零狗碎的升级外，Hugo 0.6x系统最大的变化即，跟着Gitea更换了一个GO语言的Markdown渲染器，将原先的[Blackfriday](https://github.com/russross/blackfriday)换成了[Goldmark](https://github.com/yuin/goldmark/)，基于CommonMark规范标准，支持GFM。
